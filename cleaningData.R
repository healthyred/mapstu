...
#totalframe<- merge(year2000, year2001, by= c("State.Countries"))
#totalframe<- merge(totalframe, year2002, by= c("State.Countries"))
#totalframe<- merge(totalframe, year2003, by= c("State.Countries"))
#totalframe<- merge(totalframe, year2004, by= c("State.Countries"))
#totalframe<- merge(totalframe, year2005, by= c("State.Countries"))
#totalframe<- merge(totalframe, year2006, by= c("State.Countries"))
#totalframe<- merge(totalframe, year2007, by= c("State.Countries"))
#totalframe<- merge(totalframe, year2008, by= c("State.Countries"))
#totalframe<- merge(totalframe, year2009, by= c("State.Countries"))
#totalframe<- merge(totalframe, year2010, by= c("State.Countries"))
#totalframe<- merge(totalframe, year2011, by= c("State.Countries"))
#totalframe<- merge(totalframe, year2012, by= c("State.Countries"))
#totalframe<- merge(totalframe, year2013, by= c("State.Countries"))
#totalframe<- merge(totalframe, year2014, by= c("State.Countries"))
#totalframe<- merge(totalframe, year2015, by= c("State.Countries"))
